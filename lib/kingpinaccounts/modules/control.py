...
addonObject = addon('script.module.kingpinaccounts')
...
def setting(id):
	return xbmcaddon.Addon('script.module.kingpinaccounts').getSetting(id)

def setSetting(id, value):
	return xbmcaddon.Addon('script.module.kingpinaccounts').setSetting(id, value)
...
def artPath():
	return os.path.join(xbmcaddon.Addon('script.module.kingpinaccounts').getAddonInfo('path'), 'resources', 'icons')
...
def set_active_monitor():
	window.setProperty('kingpinaccounts.active', 'true')

def release_active_monitor():
	window.clearProperty('kingpinaccounts.active')
...
def refresh_debugReversed(): # called from service "onSettingsChanged" to clear kingpinaccounts.log if setting to reverse has been changed
	if window.getProperty('kingpinaccounts.debug.reversed') != setting('debug.reversed'):
		window.setProperty('kingpinaccounts.debug.reversed', setting('debug.reversed'))
		execute('RunScript(script.module.kingpinaccounts, action=tools_clearLogFile)')