...
from kingpinaccounts.windows.base import BaseDialog
...
class TextViewerXML(BaseDialog):
	...
	def set_properties(self):
		self.setProperty('kingpinaccounts.text', self.text)
		self.setProperty('kingpinaccounts.heading', self.heading)